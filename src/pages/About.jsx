                  ...
                  <div className="mb-4">
                    ...
                    >
                      <img 
                        ...
                        onError={(e) => {
                          // Eğer resim yüklenemezse varsayılan avatar göster - XSS koruması ile
                          e.target.style.display = 'none';
                          const parent = e.target.parentElement;
                          parent.innerHTML = '';
                          
                          const fallbackDiv = document.createElement('div');
                          fallbackDiv.className = 'd-flex align-items-center justify-content-center h-100 bg-primary bg-opacity-10';
